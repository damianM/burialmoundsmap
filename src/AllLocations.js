    ...
    render() {
        ...
        return (
            <div className="search">
                <input role="search" aria-labelledby="search-field" id="search-field" className="search-field" type="text" placeholder="Search"
                       value={this.state.query} onChange={this.filterLocations}/>
                <ul>
                    {this.state.suggestions && locationlist}
                </ul>
                <button className="button" onClick={this.toggleSuggestions}>MENU</button>
            </div>
        );
    }
}
